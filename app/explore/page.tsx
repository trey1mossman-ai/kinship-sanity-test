    ...
    <ScrollEffectsWrapper>
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Your local guide to hidden gems, insider adventures, and authentic experiences
          </p>
        </div>
      </section>
      ...
      <main id="main-content">
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              There are a ton of coffee shops, cocktail joints, places to grab a bite, and entertainment within just a few blocks of Kinship! Grab your buddies and swing by one of our favorite hot spots!
            </p>
          </div>
        </section>
